...
ret_p[,`:=`(cum_rkt=cumsum(ret_lh),cum_mkt_e=cumsum(mkt_e),
            cum_smb=cumsum(smb),cum_hml=cumsum(hml))]
ret_p[,`:=`(exp_cum_rkt=exp(cum_rkt),exp_cum_mkt_e=exp(cum_mkt_e),
...
ret_plot <- melt(ret_p,id.vars="ym",
                 measure.vars=c("exp_cum_rkt","exp_cum_mkt_e"),
...
ret_plot <- melt(ret_p,id.vars="ym",
                 measure.vars=c("cum_rkt","cum_mkt_e"),
