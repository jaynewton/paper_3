...
da_all_m_strong_lottery_rvol  <- da_all_m_intermediate
da_all_m_strong_lottery_rvol[,group_n:=NULL]

#save(da_all_m_strong_lottery_rvol,file="C:/Users/Ding/Desktop/da_all_m_strong_lottery_rvol.RData")

################################# 
#### Firm-Level Cross-Sectional Regression  
load("F:/我的论文/第五篇/主代码/realized kurtosis puzzle/RData/da_all_m_strong_lottery_rvol.RData")
load("F:/我的论文/第五篇/RData/da_mom_m.RData")
load("F:/我的论文/第五篇/RData/da_beta_5y.RData")

da_m_lm <- merge(da_all_m_strong_lottery_rvol,da_mom_m,by=c("ym","SecCode"))
